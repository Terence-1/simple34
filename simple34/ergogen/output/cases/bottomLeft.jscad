...
.extrude({ offset: [0, 0, 1.1] });
                ...
                let bottomLeft__part_0 = bottomPlateNonSlip_extrude_1_outline_fn();
                ...
                // creating part 1 of case bottomLeft
                let bottomLeft__part_1 = brassInsertsPlate_extrude_1_outline_fn();

                // make sure that rotations are relative
                let bottomLeft__part_1_bounds = bottomLeft__part_1.getBounds();
                let bottomLeft__part_1_x = bottomLeft__part_1_bounds[0].x + (bottomLeft__part_1_bounds[1].x - bottomLeft__part_1_bounds[0].x) / 2
                let bottomLeft__part_1_y = bottomLeft__part_1_bounds[0].y + (bottomLeft__part_1_bounds[1].y - bottomLeft__part_1_bounds[0].y) / 2
                bottomLeft__part_1 = translate([-bottomLeft__part_1_x, -bottomLeft__part_1_y, 0], bottomLeft__part_1);
                bottomLeft__part_1 = rotate([0,0,0], bottomLeft__part_1);
                bottomLeft__part_1 = translate([bottomLeft__part_1_x, bottomLeft__part_1_y, 0], bottomLeft__part_1);

                bottomLeft__part_1 = translate([0,0,1], bottomLeft__part_1);
                result = result.union(bottomLeft__part_1);
                
            

                // creating part 2 of case bottomLeft
                let bottomLeft__part_2 = brassInsertsPos_extrude_1_45_outline_fn();

                // make sure that rotations are relative
                let bottomLeft__part_2_bounds = bottomLeft__part_2.getBounds();
                let bottomLeft__part_2_x = bottomLeft__part_2_bounds[0].x + (bottomLeft__part_2_bounds[1].x - bottomLeft__part_2_bounds[0].x) / 2
                let bottomLeft__part_2_y = bottomLeft__part_2_bounds[0].y + (bottomLeft__part_2_bounds[1].y - bottomLeft__part_2_bounds[0].y) / 2
                bottomLeft__part_2 = translate([-bottomLeft__part_2_x, -bottomLeft__part_2_y, 0], bottomLeft__part_2);
                bottomLeft__part_2 = rotate([0,0,0], bottomLeft__part_2);
                bottomLeft__part_2 = translate([bottomLeft__part_2_x, bottomLeft__part_2_y, 0], bottomLeft__part_2);

                bottomLeft__part_2 = translate([0,0,2], bottomLeft__part_2);
                result = result.union(bottomLeft__part_2);
                
            

                // creating part 3 of case bottomLeft
                let bottomLeft__part_3 = bottomPlateEdgeLower_extrude_3_45_outline_fn();

                // make sure that rotations are relative
                let bottomLeft__part_3_bounds = bottomLeft__part_3.getBounds();
                let bottomLeft__part_3_x = bottomLeft__part_3_bounds[0].x + (bottomLeft__part_3_bounds[1].x - bottomLeft__part_3_bounds[0].x) / 2
                let bottomLeft__part_3_y = bottomLeft__part_3_bounds[0].y + (bottomLeft__part_3_bounds[1].y - bottomLeft__part_3_bounds[0].y) / 2
                bottomLeft__part_3 = translate([-bottomLeft__part_3_x, -bottomLeft__part_3_y, 0], bottomLeft__part_3);
                bottomLeft__part_3 = rotate([0,0,0], bottomLeft__part_3);
                bottomLeft__part_3 = translate([bottomLeft__part_3_x, bottomLeft__part_3_y, 0], bottomLeft__part_3);

                bottomLeft__part_3 = translate([0,0,2], bottomLeft__part_3);
                result = result.union(bottomLeft__part_3);
                
            

                // creating part 4 of case bottomLeft
                let bottomLeft__part_4 = bottomPlateEdgeUpper_extrude_1_1_outline_fn();

                // make sure that rotations are relative
                let bottomLeft__part_4_bounds = bottomLeft__part_4.getBounds();
                let bottomLeft__part_4_x = bottomLeft__part_4_bounds[0].x + (bottomLeft__part_4_bounds[1].x - bottomLeft__part_4_bounds[0].x) / 2
                let bottomLeft__part_4_y = bottomLeft__part_4_bounds[0].y + (bottomLeft__part_4_bounds[1].y - bottomLeft__part_4_bounds[0].y) / 2
                bottomLeft__part_4 = translate([-bottomLeft__part_4_x, -bottomLeft__part_4_y, 0], bottomLeft__part_4);
                bottomLeft__part_4 = rotate([0,0,0], bottomLeft__part_4);
                bottomLeft__part_4 = translate([bottomLeft__part_4_x, bottomLeft__part_4_y, 0], bottomLeft__part_4);

                bottomLeft__part_4 = translate([0,0,5.35], bottomLeft__part_4);
                result = result.union(bottomLeft__part_4);
