...
const uint16_t PROGMEM fjcaps_combo[] = {LSFT_T(KC_F), RSFT_T(KC_J), COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,     _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,
        KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,     _______, _______, _______, _______, _______,
        KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,     _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
                                   _______, _______,     _______, _______
    ),
    [4] = LAYOUT(
        KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT,     _______, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, 
